...
if ismac && isunix  % if on Mac
    ...
    save_path = '/Users/wu-jung/code_git/ooi_sonar/decomp_results_classic_nmf/';
elseif isunix  % if on Linux
    addpath ~/code_git/ooi_sonar/palm_nmf_matlab
    data_path = '~/code_git/ooi_sonar/sample_data/';
    save_path = '~/code_git/ooi_sonar/decomp_results_classic_nmf/';
end
...
rank_all = 1:30;
opt = statset('MaxIter',500,'Display','final','TolFun',1e-5);
