...
PARAM_FILE="'/scratch/ch153/wjl/params_20191027_rank10.txt'"
matlab -nodisplay -nosplash -singleCompThread -r "addpath('../');ssNMF_runner_normvar_repeat_sp02($PARAM_FILE, $SLURM_ARRAY_TASK_ID);exit;"
