...
PARAM_FILE="'/scratch/ch153/wjl/params_20191027_betaHW_rank04.txt'"
matlab -nodisplay -nosplash -singleCompThread -r "addpath('../');ssNMF_runner_normvar_betaHW($PARAM_FILE, $SLURM_ARRAY_TASK_ID);exit;"
