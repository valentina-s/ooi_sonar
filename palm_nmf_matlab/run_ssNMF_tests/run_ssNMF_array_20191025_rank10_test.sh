...
PARAM_FILE="'/scratch/ch153/wjl/params_20190915_rank10.txt'"
RSEED_FILE="'/scratch/ch153/wjl/rand_seed.txt'"
matlab -nodisplay -nosplash -singleCompThread -r "ssNMF_runner_normvar_repeat($PARAM_FILE, $SLURM_ARRAY_TASK_ID);exit;"
